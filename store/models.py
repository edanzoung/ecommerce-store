...
class Product(models.Model):
    ...
    image1_drone = models.ImageField(storage=custom_store,upload_to='media/drones/', max_length=255)
    image2_drone = models.ImageField(storage=custom_store,upload_to='media/drones/', max_length=255)
    image3_drone = models.ImageField(storage=custom_store,upload_to='media/drones/', max_length=255)
    image4_drone = models.ImageField(storage=custom_store,upload_to='media/drones/', max_length=255)
    image5_drone = models.ImageField(storage=custom_store,upload_to='media/drones/', max_length=255)
